...
#'
#' @description Creates a new page on the WordPress site provided using the credentials entered, with content and
...
#' @param pass The password to be used in the API call to create the page. To get this value, you must have the
#' Application Passwords plugin
#' installed, and must create an application using that plugin via your WordPress admin panel; there
#' you will get the password needed.
